...
import com.frodrigues.odbmqtt.bluetooth.BluetoothDeviceInfo
...
fun SettingsScreen(
    ...
    bluetoothProvider: BluetoothTransportProvider,
    onBack: () -> Unit,
    ...
    suspend fun refreshDevices() {
        pairedDevices = bluetoothProvider.listPairedDevices()
    }
        ...
        AlertDialog(
            ...
            title = {
                Row(
                    ...
                    IconButton(onClick = { scope.launch { refreshDevices() } }) {
                        Icon(
                        ...
                        pairedDevices.forEachIndexed { index, device ->
                            ...
                            ListItem(
                                ...
                                modifier = Modifier.clickable(
                                    ...
                                    onClickLabel = "Select ${device.name}"
                                ) {
                                    scope.launch {
                                        settings.setString(AppSettings.BT_DEVICE_MAC, device.address)
                                    }
        ...
        Column(
            ...
            SettingsSection(header = { SectionLabel("Bluetooth Device") }) {
                Column(
                    ...
                    OutlinedButton(
                        ...
                        Text(
                            text = selectedDevice?.name ?: "Tap to select a device…",
                    ...
                    if (selectedDevice != null && btMac.isNotBlank()) {
                        Text(
                            text = btMac,
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                ...
                Column(
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                localHost = it
                                scope.launch { settings.setString(AppSettings.MQTT_HOST, it) }
                            },
                            label = { Text("Host") },
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = { v ->
                                ...
                                v.toIntOrNull()?.let { port ->
                                    scope.launch { settings.setInt(AppSettings.MQTT_PORT, port) }
                                }
                            },
                            label = { Text("Port") },
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {
                            localUser = it
                            scope.launch { settings.setString(AppSettings.MQTT_USER, it) }
                        },
                        label = { Text("Username") },
                        singleLine = true,
                        modifier = Modifier.fillMaxWidth()
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {
                            localPassword = it
                            scope.launch { settings.setString(AppSettings.MQTT_PASSWORD, it) }
                        },
                        label = { Text("Password") },
                        singleLine = true,
                ...
                Column(
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                localDeviceName = it
                                scope.launch { settings.setString(AppSettings.DEVICE_NAME, it) }
                            },
                            label = { Text("Name") },
                            singleLine = true,
                            modifier = Modifier.weight(1f)
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {
                                localDeviceModel = it
                                scope.launch { settings.setString(AppSettings.DEVICE_MODEL, it) }
                            },
                            label = { Text("Model") },
                            singleLine = true,
                            modifier = Modifier.weight(1f)
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = {
                            localDeviceManufacturer = it
                            scope.launch { settings.setString(AppSettings.DEVICE_MANUFACTURER, it) }
                        },
            ...
            Card(
                ...
                ListItem(
                    ...
                    modifier = Modifier.clickable(enabled = totalCount > 0, onClick = onNavigateToPidSelection)
                )
            }
